...
{
    [TestFixture]
    public class ExtractAlphaTrueBeatUniverseTests
    {
        [Test]
        ...
        private IEnumerable<ExtractAlphaTrueBeatUniverse> CreateNewSelection()
        {
            return new []
            {
                new ExtractAlphaTrueBeatUniverse
                {
                    TrueBeat = 1000m,
                    ExpertBeat = 10m,
                    TrendBeat = 90m,
